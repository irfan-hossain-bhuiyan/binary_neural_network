...
| A1 | 4-bit unsigned addition | New deterministic compositional benchmark | 5 planned | not run | not run | runner prepared; experiment not run | `run_a1_binary_addition.py` | not created |
