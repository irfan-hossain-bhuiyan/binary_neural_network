...
def main() -> None:
    ...
    if ENTRY:
        ...
        elif ENTRY.endswith("initialization_i2f_kaggle.py"):
        ...
        elif ENTRY.endswith("run_a3_tolerance_loss.py"):
            metrics_name = "research/operator_results/a3_tolerance_loss_results.json"
        elif ENTRY.endswith("run_a4_staged_tolerance.py"):
            metrics_name = "research/operator_results/a4_staged_tolerance_results.json"
        elif ENTRY.endswith("run_a5_target_gini.py"):
            metrics_name = "research/operator_results/a5_target_gini_results.json"
        elif ENTRY.endswith("run_a6_error_distribution.py"):
            metrics_name = "research/operator_results/a6_error_distribution_results.json"
        else:
    ...
    checkpoint_manifest = next((REPO_DIR / name for name in ("b3r_checkpoint_manifest.json", "b3r_continuation_manifest.json", "i2_checkpoint_manifest.json", "initialization_i2f_checkpoint_manifest.json") if (REPO_DIR / name).exists()), None)
